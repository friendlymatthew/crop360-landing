						...
						<form action="#" class="sm:gap-4 sm:flex">
							<div class="sm:flex-1">
								...
								<input
									...
									class="w-full p-3 text-gray-700 bg-white border-gray-200 transition rounded-md shadow-sm focus:ring focus:outline-none focus:ring-yellow-400 focus:border-white"
								/>
							</div>
